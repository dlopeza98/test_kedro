...
# test_kedro_pivot_table documentation build
...
from test_kedro_pivot_table import __version__ as release

# -- Project information -----------------------------------------------------

project = "test_kedro_pivot_table"
author = "Kedro"
...
htmlhelp_basename = "test_kedro_pivot_tabledoc"
...
latex_documents = [
    (
        master_doc,
        "test_kedro_pivot_table.tex",
        "test_kedro_pivot_table Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "test_kedro_pivot_table",
        "Project test_kedro_pivot_table codebase.",
        "Data-Science",
    )
]
